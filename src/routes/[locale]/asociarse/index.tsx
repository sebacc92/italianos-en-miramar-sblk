...
export const useSubmitMembership = routeAction$(
  ...
  zod$({
    ...
    motivo_asociacion: z
      .string()
      .min(20, "Por favor describe tu motivación (mínimo 20 caracteres)"),
  }),
);
  ...
  return (
    <div class="flex min-h-screen flex-col bg-gray-50">
      ...
      <section class="container mx-auto max-w-4xl px-4 py-20">
        <Card.Root class="border-t-4 border-t-green-600 shadow-2xl">
              ...
              <Form action={action} class="space-y-8">
                ...
                <div class="space-y-6">
                  <div class="flex items-center gap-2 border-b pb-2">
                    <LuUser class="h-5 w-5 text-green-600" />
                ...
                <div class="space-y-6">
                  <div class="flex items-center gap-2 border-b pb-2">
                    <LuMail class="h-5 w-5 text-green-600" />
                    <h3 class="text-xl font-semibold text-gray-800">
                      {_`joinForm.contact`}
                    </h3>
                  </div>
                ...
                <div class="space-y-6">
                  <div class="flex items-center gap-2 border-b pb-2">
                    <LuMapPin class="h-5 w-5 text-green-600" />
                    <h3 class="text-xl font-semibold text-gray-800">
                  ...
                  <div class="flex items-center gap-2">
                    ...
                    />
                    <Label
                      for="tiene_ascendencia_italiana"
                ...
                <div class="space-y-6">
                  ...
                  <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    <div class="space-y-2">
                      ...
                      <Input
                        name="socio_presentante_1"
                        id="socio_presentante_1"
                    ...
                    <div class="space-y-2">
                      ...
                      <Input
                        name="socio_presentante_2"
                        id="socio_presentante_2"
                        placeholder="Nombre completo"
                      />
                    </div>
                  </div>
                ...
                <div class="space-y-6">
                  ...
                  <div class="space-y-2">
                    ...
                    <textarea
                      ...
                      rows={4}
                      class="flex w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-sm placeholder:text-gray-500 focus:ring-2 focus:ring-green-600 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50"
                ...
                <div class="pt-4">
                  <Button
                    ...
                    class="h-12 bg-green-600 text-base hover:bg-green-700"
                  >
                    {action.isRunning ? (
                      _`joinForm.submitting`
                    ) : (
                      <>
                        {_`joinForm.submit`} <LuSend class="ml-2 h-4 w-4" />
                      </>
                    )}
                  </Button>
                </div>
