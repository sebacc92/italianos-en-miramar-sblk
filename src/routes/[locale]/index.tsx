        ...
        <section class="py-16 bg-gray-50">
          <div class="container mx-auto px-4">
             <div class="mb-12 text-center">
              ...
              <div class="mx-auto h-1 w-24 rounded-full bg-gradient-to-r from-green-600 via-white to-red-600"></div>
             </div>

             <div class="grid gap-8 md:grid-cols-3 max-w-6xl mx-auto">
               {recentEvents.value.map(ev => (
                 <Card.Root key={ev.id} class="overflow-hidden hover:shadow-xl transition-shadow bg-white">
                    {ev.imageUrl && (
                    ...
                    <Card.Content>
                       <p class="text-gray-600 line-clamp-2 text-sm mb-4">{ev.description}</p>
                       <Link href={`/${recentEvents.value[0].language}/eventos/${ev.id}`} class="text-green-700 font-bold hover:underline">
                         Ver detalles →
                       </Link>
                    </Card.Content>
                 </Card.Root>
