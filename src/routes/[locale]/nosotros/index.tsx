                ...
                <section class="py-16">
                    <div class="container mx-auto px-4">
                        <div class="mb-10 text-center">
                            <h2 class="text-2xl font-semibold text-gray-700 mb-2">{_`about.visualTour`}</h2>
                ...
                <section class="py-16 bg-white">
                    <div class="container mx-auto px-4">
                        ...
                        <div class="max-w-3xl mx-auto">
                            <div>
                                <h3 class="mb-4 text-2xl font-bold text-gray-800 text-center md:text-left">{_`about.communitySpace`}</h3>
