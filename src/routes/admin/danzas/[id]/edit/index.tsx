        ...
        <Form action={updateAction} class="space-y-4">
          <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div>
              ...
              <Input name="clase" value={clase.value.clase} required />
            </div>
            <div>
              <label class="mb-1 block text-sm font-semibold text-gray-700">Categoría</label>
              <Input name="categoria" value={clase.value.categoria} required />
            </div>
            <div class="sm:col-span-2">
              <label class="mb-1 block text-sm font-semibold text-gray-700">Profesores</label>
              <Input name="profesores" value={clase.value.profesores} required />
            </div>
            <div>
            ...
            <div>
              ...
              <Input type="time" name="hora_inicio" value={clase.value.hora_inicio} required />
            </div>
            <div>
              <label class="mb-1 block text-sm font-semibold text-gray-700">Hora Fin</label>
              <Input type="time" name="hora_fin" value={clase.value.hora_fin} required />
            </div>
          </div>
